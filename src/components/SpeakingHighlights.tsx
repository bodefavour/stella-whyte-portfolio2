...
export const SpeakingEvents = () => {
  return (
    <section className="bg-[#0e0e10] text-white py-16 px-6 md:px-20">
                ...
                {event.images.map((img, i) => (
                  <div key={i} className="px-2">
                    <img
                      ...
                      className="rounded-xl h-52 w-full object-cover cursor-pointer transition duration-300 hover:opacity-80"
                    />
                  </div>
                ))}
              </Slider>
